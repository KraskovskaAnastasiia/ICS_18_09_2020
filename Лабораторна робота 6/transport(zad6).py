...
class Transport:
    ...
    def __str__(self) -> str:
        return f"Вартість: {self._cost} Швидкість: {self._velocity} Рік випуску: {self._year_of_production} Координата x: {self._coordinateX} Координата y: {self._coordinateY}"
...
class Plane(Transport):
    ...
    def __str__(self) -> str:
        return super().__str__() + f" Висота: {self.height} Кількість пасажирів: {self.amount_of_passengers}"
...
class Ship(Transport):
    ...
    def __str__(self) -> str:
        return super().__str__() + f" Номер порта: {self.port_id} Кількість пасажирів: {self.amount_of_passengers}"
...
plane.cost = 540000
plane.velocity = 2530
plane.year_of_production = 2015
plane.coordinateX = 12.4
plane.coordinateY = 55.4
plane.amount_of_passengers = 258
plane.height = 238
...
ship.cost = 538000
ship.velocity = 100
ship.year_of_production = 2019
ship.coordinateX = 44.4
ship.coordinateY = 87.4
ship.port_id = 4
ship.amount_of_passengers = 760
